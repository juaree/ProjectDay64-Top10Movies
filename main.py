...
class Movie(db.Model):
    ...
    img_url = db.Column(db.String(255), unique=False, nullable=False)
...
def add_movie():
    movie_id = request.args.get('unique_id')
    TMDB_ENDPOINT_DETAILS = f"https://api.themoviedb.org/3/movie/{movie_id}"
    TMDB_PARAMS = {
        "api_key": TMDB_API_KEY,
    }
